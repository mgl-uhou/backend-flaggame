...
const swaggerDocs = {
	...
	info: {
		title: "FlagGame API",
		description: "API de CRUD para os usuários e modos de jogo do FlagGame para guiar os frontends.",
	...
	paths: {
		"/users": {
									...
									oneOf: [
										{
											...
											items: {
												...
												properties: {
													message: {
														type: "string",
														description: "Mensagem descrevendo um erro de validação"
													}
												}
											}
										},
			...
			put:{
				...
				description: "Rota que atualiza os dados do usuário, podendo atualizar o nickname, o email, a senha ou todos de uma vez. \n\nRota protegida. Necessita de autenticação.",
				tags: ["Users"],
				security: [{ bearerAuth: [] }],
				requestBody: {
					content: {
							...
							"application/json": {
								schema: {
									...
									properties: {
										...
										error: {
											type: "object",
											description: "Erro retornado do JWT.",
											properties: {
												name: {
													type: "string",
												},
			...
			delete: {
				summary: "Deleta o perfil do usuário com base no id do token de autenticação.",
				description: "Rota que deleta o perfil do usuário, podendo deletar o perfil de uma vez. \n\nRota protegida. Necessita de autenticação.",
				tags: ["Users"],
				security: [{ bearerAuth: [] }],
				responses: {
					200: {
		...
		"/users/login": {
			post: {
				...
				description: "Rota post de login de usuário para obter o token de autenticação e outras informações.",
				tags: ["Users"],
				requestBody: {
					content: {
						"application/json": {
		...
		"/users/profile": {
			get: {
				summary: "Retorna o perfil do usuário com base no token de autenticação.",
				description: "Rota get que retorna os dados do usuário a partir do token de autenticação. \n\nRota protegida. Necessita de autenticação.",
				tags: ["Users"],
				security: [{ bearerAuth: [] }],
				responses: {
					200: {
		...
		"/flags": {
			...
			get: {
				...
				description: "Rota get para buscar todas as bandeiras cadastradas no banco.",
				tags: ["Flags"],
				responses: {
					200: {
		...
		"/flags/{id}": {
			get: {
				...
				description: "Rota get para buscar uma bandeira com base em seu id.",
				tags: ["Flags"],
				parameters: [
					{
						name: "id",
			...
			delete: {
				...
				responses: {
					...
					400: {
						description: "Erro ao deletar bandeira, seja por erro do banco ou bandeira não encontrada.",
						content: {
							"application/json": {
								schema: {
									$ref: "#/components/schemas/DefaultError"
